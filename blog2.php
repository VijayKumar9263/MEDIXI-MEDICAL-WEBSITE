            ...
            <div class="col-12">
                <div class="service-content mb-30">
                    <div style="
                        ...
                        text-align: justify;
                    ">
                        <h2 style="text-align: center;">Therapy</h2>
                        <p>
                            At Medixi, we offer a comprehensive range of therapy services designed to support your mental and emotional well-being. Our therapy services are tailored to meet your individual needs and help you navigate life's challenges with resilience and strength.
                        </p>
                        <p>
                            <strong>Individual Therapy:</strong> Our individual therapy sessions provide a safe and confidential space for you to explore your thoughts, feelings, and behaviors. Our experienced therapists work with you one-on-one to address personal issues, develop coping strategies, and promote personal growth.
                        </p>
                        <p>
                            <strong>Couples Therapy:</strong> Relationships can be challenging, and our couples therapy sessions are designed to help partners improve communication, resolve conflicts, and strengthen their bond. Our therapists facilitate open and honest discussions to help couples understand each other better and find common ground.
                        </p>
                        <p>
                            <strong>Family Therapy:</strong> Family dynamics can significantly impact individual well-being. Our family therapy sessions aim to improve communication and resolve conflicts within the family unit. We work with all family members to address issues and promote a healthier, more supportive family environment.
                        </p>
                        <p>
                            <strong>Group Therapy:</strong> Group therapy provides a supportive environment where individuals can share their experiences and learn from others facing similar challenges. Our group therapy sessions are facilitated by trained professionals and focus on various topics such as stress management, anxiety, depression, and more.
                        </p>
                        <p>
                            At Medixi, we are dedicated to providing high-quality therapy services to help you achieve mental and emotional well-being. Our compassionate and skilled therapists are here to support you on your journey to a healthier, more fulfilling life.
                        </p>
                    </div>
                </div>
            </div>
