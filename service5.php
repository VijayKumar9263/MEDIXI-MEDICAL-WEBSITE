            ...
            <div class="col-12">
                <div class="service-content mb-30">
                    <div style="
                        ...
                        text-align: justify;
                    ">
                        <h2 style="text-align: center;">Expert Surgeon</h2>
                        <p>
                            At Medixi, our Expert Surgeon services offer advanced surgical care with a focus on patient safety and successful outcomes. Our highly skilled surgeons provide a wide range of surgical procedures tailored to meet your specific health needs.
                        </p>
                        <p>
                            <strong>Pre-Surgical Consultation:</strong> We conduct thorough pre-surgical consultations to evaluate your health condition and determine the best surgical approach. Our surgeons provide detailed information and answer any questions you may have.
                        </p>
                        <p>
                            <strong>Advanced Surgical Techniques:</strong> Our surgeons are proficient in the latest surgical techniques, including minimally invasive and laparoscopic surgeries. These techniques often result in less pain, shorter recovery times, and better outcomes.
                        </p>
                        <p>
                            <strong>Post-Surgical Care:</strong> Comprehensive post-surgical care is essential for a smooth recovery. We provide detailed post-operative instructions, follow-up appointments, and ongoing support to ensure optimal healing and recovery.
                        </p>
                        <p>
                            <strong>Specialized Surgeries:</strong> We offer specialized surgical procedures across various medical fields, including orthopedic, cardiovascular, gastrointestinal, and oncological surgeries. Our multidisciplinary approach ensures you receive the best care.
                        </p>
                        <p>
                            At Medixi, our Expert Surgeon services are dedicated to providing top-notch surgical care. Our team is committed to ensuring your safety, comfort, and successful recovery.
                        </p>
                    </div>
                </div>
            </div>
