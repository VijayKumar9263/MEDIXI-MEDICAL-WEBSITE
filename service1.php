            ...
            <div class="col-12">
                <div class="service-content mb-30">
                    <div style="
                        ...
                        text-align: justify;
                    ">
                        <h2 style="text-align: center;">Haematology</h2>
                        <p>
                            At Medixi, our Haematology services are dedicated to the diagnosis and treatment of blood disorders. Our team of experts provides comprehensive care for a wide range of haematological conditions, ensuring that you receive the best possible treatment.
                        </p>
                        <p>
                            <strong>Blood Tests and Diagnostics:</strong> We offer a variety of blood tests to diagnose conditions such as anemia, clotting disorders, and blood cancers. Our advanced diagnostic techniques help us to accurately identify and monitor these conditions.
                        </p>
                        <p>
                            <strong>Treatment of Blood Disorders:</strong> Our haematology specialists provide treatment for various blood disorders, including leukemia, lymphoma, and myeloma. We develop personalized treatment plans that may include medication, chemotherapy, or other therapies to manage and treat your condition effectively.
                        </p>
                        <p>
                            <strong>Management of Anemia:</strong> Anemia is a common condition that can significantly impact your quality of life. We offer comprehensive management plans for different types of anemia, including iron-deficiency anemia, vitamin deficiency anemia, and chronic disease anemia.
                        </p>
                        <p>
                            <strong>Clotting and Bleeding Disorders:</strong> Proper management of clotting and bleeding disorders is essential for preventing complications. Our specialists provide diagnosis, treatment, and ongoing management for conditions such as hemophilia, deep vein thrombosis (DVT), and other clotting disorders.
                        </p>
                        <p>
                            <strong>Bone Marrow Transplant:</strong> For certain blood disorders, a bone marrow transplant may be necessary. We provide expert care and coordination for bone marrow transplant procedures, including pre-transplant evaluations and post-transplant care to ensure the best outcomes.
                        </p>
                        <p>
                            At Medixi, we are committed to providing exceptional haematology care. Our team is dedicated to offering compassionate support and advanced treatment options to help you manage your blood disorder and maintain your overall health.
                        </p>
                    </div>
                </div>
            </div>
