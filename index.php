...
============================== -->
        ...
        <div class="sidemenu-content">
            ...
            <div class="widget footer-widget   ">
                ...
                <div class="address-line">
                    ...
                    <a href="#" class="text-reset fs-md">Gautam Navlakha Apartment</a>
                </div>
            </div>
            <div class="widget footer-widget  ">
                        ...
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="col text-end text-lg-center">
                                <nav class="main-menu menu-style1 d-none d-lg-block">
                                    <ul>
                                        <li class="menu-item">
                                            <a href="#"><span class="has-new-label">Home</span></a>
                                        </li>
                                        <li>
    ...
    <section class="vs-hero-wrapper position-relative  ">
        <div class="vs-hero-carousel" data-navprevnext="true" data-height="800" data-container="1900" data-slidertype="responsive">
            <div class="ls-slide" data-ls="duration: 5000; transition2d: 5;">
                <img src="assets/img/hero/h-bg-3-1.jpg" alt="Hero Image" class="ls-bg">
                <h1 class="text-title ls-l ls-responsive" data-ls-mobile="left: 100px; top: 120px; font-size: 120px;" data-ls-tablet="left: 100px; top: 80px; font-size: 92px;" data-ls-laptop="left: 100px; top: 120px; font-size: 82px;" style="left: 335px; top: 208px; font-size: 72px; font-weight: 700;" data-ls="delayin: 600; easingin: easeInOutSine; texttransitionin: true; textstartatin: transitioninstart; textdurationin: 2000; texttypein: words_asc; textshiftin: 200; textoffsetyin: -100; offsetyout: -100; durationout: 2000; ">We always prioritize</h1>
                <h1 class="text-white ls-l ls-responsive" data-ls-mobile="left: 100px;  top: 285px; font-size: 120px;" data-ls-tablet="left: 100px; top: 210px; font-size: 92px;" data-ls-laptop="left: 100px; top: 230px; font-size: 82px;" style="left: 335px; top: 290px; font-size: 72px; font-weight: 700;" data-ls="delayin: 0; easingin: easeInOutSine; texttransitionin: true; textstartatin: transitioninstart; textdurationin: 2000; texttypein: words_asc; textshiftin: 200; textoffsetyin: -100; offsetyout: -100; durationout: 2000; ">our patients' well-being</h1>
                <p class="ls-l text-white ls-responsive ls-hide-sm" data-ls-mobile="left: 100px; " data-ls-tablet=" left: 100px; top: 360px; font-size: 34px; width: 1000px; line-height: 52px;" data-ls-laptop="left: 100px; top: 380px; font-size: 26px; width: 800px; line-height: 48px;" style="left: 335px; top: 400px; width: 605px; font-size: 16px; font-weight: 400; white-space: normal; letter-spacing: 0.02em; line-height: 28px;" data-ls="delayin: 800; texttransitionin: true; textstartatin: transitioninstart; texttypein: lines_asc; textshiftin: 100; textoffsetyin: 100; textdurationin: 2000; offsetyout: 100; durationout: 2000; ">Streamline advanced care models with cutting-edge technology. Efficiently deliver safe, high-quality interventions for essential diagnostic and therapeutic services.</p>
                <div class="ls-btn ls-l ls-responsive" data-ls-mobile="left: 100px; " data-ls-tablet="left: 100px; top: 580px;" data-ls-laptop="left: 100px; top: 580px;" style="left: 335px; top: 518px;" data-ls="offsetyin: 200; durationin: 2000; delayin: 1400; offsetyout: 300; durationout: 2000; offsetyout: 100; durationout: 2000; ">
                    <a href="service.php" class="vs-btn style3 hover-white">View All Services<i class="fas fa-bolt"></i></a>
                </div>
            </div>
            <div class="ls-slide" data-ls="duration: 5000; transition2d: 5;">
                ...
                <p class="ls-l text-white ls-responsive ls-hide-sm" data-ls-mobile="left: 100px; " data-ls-tablet=" left: 100px; top: 360px; font-size: 34px; width: 1000px; line-height: 52px;" data-ls-laptop="left: 100px; top: 380px; font-size: 26px; width: 800px; line-height: 48px;" style="left: 335px; top: 400px; width: 605px; font-size: 16px; font-weight: 400; white-space: normal; letter-spacing: 0.02em; line-height: 28px;" data-ls="delayin: 800; texttransitionin: true; textstartatin: transitioninstart; texttypein: lines_asc; textshiftin: 100; textoffsetyin: 100; textdurationin: 2000; offsetyout: 100; durationout: 2000; ">Implement innovative healthcare solutions with a focus on long-term wellness. Expertly provide comprehensive, evidence-based treatments for optimal patient outcomes.</p>
                <div class="ls-btn ls-l ls-responsive" data-ls-mobile="left: 100px; " data-ls-tablet="left: 100px; top: 580px;" data-ls-laptop="left: 100px; top: 580px;" style="left: 335px; top: 518px;" data-ls="offsetyin: 200; durationin: 2000; delayin: 1400; offsetyout: 300; durationout: 2000; offsetyout: 100; durationout: 2000; ">
                    <a href="service.php" class="vs-btn style3 hover-white">View All Services<i class="fas fa-bolt"></i></a>
                </div>
            </div>
            <div class="ls-slide" data-ls="duration: 5000; transition2d: 5;">
                ...
                <h1 class="text-white ls-l ls-responsive" data-ls-mobile="left: 100px;  top: 285px; font-size: 120px;" data-ls-tablet="left: 100px; top: 210px; font-size: 92px;" data-ls-laptop="left: 100px; top: 230px; font-size: 82px;" style="left: 335px; top: 290px; font-size: 72px; font-weight: 700;" data-ls="delayin: 0; easingin: easeInOutSine; texttransitionin: true; textstartatin: transitioninstart; textdurationin: 2000; texttypein: words_asc; textshiftin: 200; textoffsetyin: -100; offsetyout: -100; durationout: 2000; ">and physicians</h1>
                <p class="ls-l text-white ls-responsive ls-hide-sm" data-ls-mobile="left: 100px; " data-ls-tablet=" left: 100px; top: 360px; font-size: 34px; width: 1000px; line-height: 52px;" data-ls-laptop="left: 100px; top: 380px; font-size: 26px; width: 800px; line-height: 48px;" style="left: 335px; top: 400px; width: 605px; font-size: 16px; font-weight: 400; white-space: normal; letter-spacing: 0.02em; line-height: 28px;" data-ls="delayin: 800; texttransitionin: true; textstartatin: transitioninstart; texttypein: lines_asc; textshiftin: 100; textoffsetyin: 100; textdurationin: 2000; offsetyout: 100; durationout: 2000; ">Utilize state-of-the-art medical practices with an experienced team. Professionally deliver superior care with a commitment to excellence and patient satisfaction.</p>
                <div class="ls-btn ls-l ls-responsive" data-ls-mobile="left: 100px; " data-ls-tablet="left: 100px; top: 580px;" data-ls-laptop="left: 100px; top: 580px;" style="left: 335px; top: 518px;" data-ls="offsetyin: 200; durationin: 2000; delayin: 1400; offsetyout: 300; durationout: 2000; offsetyout: 100; durationout: 2000; ">
                    <a href="service.php" class="vs-btn style3 hover-white">View All Services<i class="fas fa-bolt"></i></a>
                </div>
            </div>
            ...
            <div class="row  text-center justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="section-title">
                        ...
                        <p>Innovatively enhance personalized patient care with a dedicated team. Deliver exceptional healthcare solutions utilizing advanced technology and best practices, tailored to meet your needs.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-4 mb-25">
                    <div class="service-box ">
                        ...
                        <div class="sr-content">
                            <h3 class="h4"><a class="text-reset" href="medical-advice-&-checkup.php">Medical Advices & Checkup</a></h3>
                            <p class="fs-xs">Comprehensive consultations and routine checkups for your overall health.</p>
                        </div>
                        <a href="medical-advice-&-checkup.php" class="icon-btn style4"><i class="far fa-long-arrow-alt-right"></i></a>
                    </div>
                </div>
                <div class="col-xl-4 mb-25">
                    <div class="service-box ">
                        ...
                        <div class="sr-content">
                            <h3 class="h4"><a class="text-reset" href="Cardiovascular-for-Women's.php">Cardiovascular for Women's</a></h3>
                            <p class="fs-xs">Specialized cardiovascular care for women's unique health needs.</p>
                        </div>
                        <a href="Cardiovascular-for-Women's.php" class="icon-btn style4"><i class="far fa-long-arrow-alt-right"></i></a>
                    </div>
                </div>
                <div class="col-xl-4 mb-25">
                    <div class="service-box ">
                        ...
                        <div class="sr-content">
                            <h3 class="h4"><a class="text-reset" href="Heart-Checkup-or-Cardiovascular.php">Heart Checkup or Cardiovascular</a></h3>
                            <p class="fs-xs">Advanced heart checkups and comprehensive cardiovascular care.</p>
                        </div>
                        <a href="Heart-Checkup-or-Cardiovascular.php" class="icon-btn style4"><i class="far fa-long-arrow-alt-right"></i></a>
                    </div>
                </div>
                <div class="col-xl-4 mb-25">
                    <div class="service-box ">
                        ...
                        <div class="sr-content">
                            <h3 class="h4"><a class="text-reset" href="Laboratory-&-Pathology-Drag.php">Laboratory & Pathology Drag</a></h3>
                            <p class="fs-xs">Comprehensive lab and pathology services for accurate diagnostics.</p>
                        </div>
                        <a href="Laboratory-&-Pathology-Drag.php" class="icon-btn style4"><i class="far fa-long-arrow-alt-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="about-content mb-2 ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-10">
                                <p class="mb-4">At Medixi, we are dedicated to providing comprehensive medical and general care services that prioritize your well-being. Our mission is to deliver efficient, user-centric healthcare solutions through advanced technology and synergistic products.</p>
                            </div>
                        </div>
                    ...
                    <div class="about-content">
                        ...
                        <div class="row">
                            <div class="col-xl-10 mb-md-2 pb-md-1">
                                <p class="mb-md-4">
                                Medixi is transforming healthcare with personalized, high-quality services tailored to your needs, supported by decades of experience and a dedication to excellence.</p>
                            </div>
            ...
            <div class="row  text-center justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-6 wow fadeIn" data-wow-delay="0.3s">
                    <div class="section-title">
                        ...
                        <p class="text-white">At Medixi, we proactively innovate customer service, leveraging internal and organic sources post-pandemic. Our approach focuses on nurturing proactive human capital to ensure exceptional healthcare outcomes.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row  text-center justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="section-title">
                            ...
                            <p>I have experienced firsthand how Medixi proactively revolutionizes customer service post-pandemic. Their dedication to internal and organic sources of human capital ensures exceptional healthcare delivery.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row vs-carousel wow fadeInUp" data-wow-delay="0.3s" data-slide-show="2">
                            <div class="col-xl-6">
                                <div class="testimonial-box mb-30 bg-white">
                                    <div class="content">
                                        <p class="fs-md">Medixi has transformed my healthcare experience. The appointment scheduling is seamless, and the care I receive is exceptional. Highly recommended!</p>
                                    </div>
                            ...
                            <div class="col-xl-6">
                                <div class="testimonial-box mb-30 bg-white">
                                    <div class="content">
                                        <p class="fs-md">I love how easy it is to manage my appointments on Medixi. The staff is professional, and the medical care is top-notch.</p>
                                    </div>
                                    <div class="author-img">
                                        <div class="avater-line"></div>
                                        <div class="avater">
                            ...
                            <div class="col-xl-6">
                                <div class="testimonial-box mb-30 bg-white">
                                    <div class="content">
                                        <p class="fs-md">Medixi provides outstanding medical services with a personal touch. The user-friendly website makes it convenient to book appointments and access my health records. </p>
                                    </div>
                                    <div class="author-img">
                                        <div class="avater-line"></div>
                                        <div class="avater">
            ...
            <div class="row  text-center justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-6 wow fadeIn" data-wow-delay="0.3s">
                    <div class="section-title">
                        ...
                        <p>Enhancing customer service post-pandemic with proactive human capital and organic growth.</p>
                    </div>
                </div>
            </div>
