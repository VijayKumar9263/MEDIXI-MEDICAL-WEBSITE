            ...
            <div class="col-12">
                <div class="service-content mb-30">
                    <div style="
                        ...
                        text-align: justify;
                    ">
                        <h2 style="text-align: center;">Gynecologist</h2>
                        <p>
                            At Medixi, our Gynecologist services are dedicated to women's health, providing comprehensive care throughout every stage of life. Our skilled gynecologists offer a wide range of services tailored to meet your unique needs.
                        </p>
                        <p>
                            <strong>Routine Gynecological Exams:</strong> Regular exams are crucial for maintaining reproductive health. We offer Pap smears, pelvic exams, and breast exams to detect any issues early and ensure optimal health.
                        </p>
                        <p>
                            <strong>Pregnancy and Prenatal Care:</strong> Our gynecologists provide expert care throughout pregnancy, from conception to delivery. We offer prenatal screenings, ultrasounds, and ongoing support to ensure a healthy pregnancy and safe delivery.
                        </p>
                        <p>
                            <strong>Menstrual and Hormonal Issues:</strong> We diagnose and treat various menstrual and hormonal disorders, including irregular periods, PCOS, and menopause symptoms. Our personalized treatment plans help manage these conditions effectively.
                        </p>
                        <p>
                            <strong>Reproductive Health and Fertility:</strong> We provide counseling and treatment for reproductive health issues and fertility concerns. Our services include fertility evaluations, treatments, and guidance on family planning.
                        </p>
                        <p>
                            At Medixi, we are committed to providing compassionate and comprehensive care for women's health. Our Gynecologist services are designed to support your well-being at every stage of life.
                        </p>
                    </div>
                </div>
            </div>
