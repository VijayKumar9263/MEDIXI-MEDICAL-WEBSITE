            ...
            <div class="col-12">
                <div class="service-content mb-30">
                    <div style="
                        ...
                        text-align: justify;
                    ">
                        <h2 style="text-align: center;">Nephrologist</h2>
                        <p>
                            At Medixi, our Nephrologist services focus on the diagnosis and treatment of kidney-related conditions. Our experienced nephrologists provide comprehensive care to help manage and treat kidney diseases effectively.
                        </p>
                        <p>
                            <strong>Kidney Function Assessment:</strong> We perform detailed evaluations of kidney function through blood tests, urine tests, and imaging studies. These assessments help us diagnose and monitor various kidney conditions.
                        </p>
                        <p>
                            <strong>Chronic Kidney Disease Management:</strong> Managing chronic kidney disease requires ongoing care and monitoring. Our nephrologists develop personalized treatment plans to slow disease progression and manage symptoms effectively.
                        </p>
                        <p>
                            <strong>Dialysis Care:</strong> For patients with advanced kidney disease, we offer dialysis treatment. Our team provides hemodialysis and peritoneal dialysis services, ensuring you receive the best care and support during treatment.
                        </p>
                        <p>
                            <strong>Kidney Transplant Care:</strong> We provide pre-transplant evaluations and post-transplant care for kidney transplant patients. Our comprehensive approach ensures you are well-prepared for the transplant and supported throughout the recovery process.
                        </p>
                        <p>
                            <strong>Hypertension Management:</strong> High blood pressure can significantly impact kidney health. Our nephrologists offer specialized care to manage hypertension and protect kidney function, reducing the risk of complications.
                        </p>
                    </div>
                </div>
            </div>
