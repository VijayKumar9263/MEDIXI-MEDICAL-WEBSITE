...
============================== -->
    ...
    <header class="header-wrapper header-layout1">
        ...
        <section class="vs-service-wrapper space-top space-md-bottom">
            ...
            text-align: justify;
        ">
            <h2 style="text-align: center;">Medical Advices & Checkup</h2>
            <p>
                At Medixi, our Medical Advices & Checkup service is committed to ensuring your overall health and well-being through comprehensive consultations and routine examinations. Our experienced healthcare professionals provide personalized advice tailored to your specific health needs.
            </p>
            <p>
                <strong>Personalized Consultations:</strong> Our consultations involve in-depth discussions about your health concerns and medical history. We take the time to understand your lifestyle, diet, and habits to offer expert advice on how to improve your health. This personalized approach helps us provide recommendations that are specific to your individual needs, promoting a healthier lifestyle.
            </p>
            <p>
                <strong>Routine Examinations:</strong> Regular checkups are a cornerstone of maintaining good health. During these examinations, our healthcare professionals conduct thorough physical exams and monitor vital signs such as blood pressure, heart rate, and body mass index (BMI). We also perform necessary screenings to detect any underlying health issues that may not yet show symptoms.
            </p>
            <p>
                <strong>Early Detection:</strong> Early detection is crucial in preventing and managing health conditions. Our routine checkups aim to identify potential health problems before they become serious. If any issues are detected, we recommend further tests or specialist referrals to ensure you receive the appropriate care. Our proactive approach helps in timely intervention and treatment, enhancing your chances of a healthier life.
            </p>
            <p>
                At Medixi, we believe in the power of preventive care. Our Medical Advices & Checkup service is designed to help you stay ahead of potential health issues, ensuring that you receive the best possible care and guidance to maintain your well-being.
            </p>
